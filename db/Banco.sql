...
(1, 'João Silva', 'Empresa ABC', '2024-07-05', '10:00:00', 'Nobre, Auditório, Figueira'),
(2, 'Maria Oliveira', 'Empresa XYZ', '2024-07-10', '14:30:00', 'Mangueira, Abacateiro, Chalé Standart'),
(3, 'Pedro Santos', 'Corporação 123', '2024-07-15', '09:00:00', 'Villa Atibainha, Chalé Suiço'),
(1, 'Ana Costa', 'Grupo Empresarial', '2024-07-20', '11:00:00', 'Sabiá, Primavera, Chalé Family 2D'),
(2, 'Carlos Ferreira', 'Consultoria ABC', '2024-07-25', '15:00:00', 'Pinheiro, Chalé Family 1D');

-- =============================================
-- Dados de teste - Visitas para Agosto/2024
-- =============================================
INSERT INTO tb_visitas (tb_usuario_id, tb_nome, tb_empresa, tb_data, tb_hora, tb_locais) VALUES
(3, 'Fernanda Lima', 'Empresa DEF', '2024-08-03', '10:30:00', 'Nobre, Auditório, Villa Atibainha'),
(1, 'Roberto Alves', 'Corporação 456', '2024-08-08', '13:00:00', 'Figueira, Mangueira, Chalé Standart'),
(2, 'Juliana Mendes', 'Grupo XYZ', '2024-08-12', '09:30:00', 'Abacateiro, Chalé Family 1D'),
(3, 'Marcelo Souza', 'Consultoria 789', '2024-08-18', '14:00:00', 'Pinheiro, Sabiá, Chalé Suiço'),
(1, 'Patrícia Gomes', 'Empresa GHI', '2024-08-22', '11:30:00', 'Primavera, Chalé Family 2D'),
(2, 'Lucas Martins', 'Corporação JKL', '2024-08-28', '16:00:00', 'Nobre, Auditório, Villa Atibainha');